...
void generarVector(int n, int v[], int infe, int supe){
	...
	/*
	cout<< "Tamaño del vector: " << sizeof(nuevo) << endl;
	cout<< "Tamaño entero: " << sizeof(int) << endl;
	cout<< "Longitud del vector: " << sizeof(nuevo)/sizeof(int) << endl;*/
...
int numAleatorio(int inferior, int superior){
	int num = inferior+rand()%(superior+1-inferior);	
	return num;
}
